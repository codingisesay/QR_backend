<?php
// app/Models/DomainShared/QrCode.php
namespace App\Models\DomainShared;

class QrCode extends BaseSharedModel
{
    protected $table = 'qr_codes_s';
    protected $fillable = [
        'tenant_id','token','token_ver','status','version','product_id','batch_id','channel_id','print_run_id',
